	...
	-- VUELOS
		...
		-- AEROPUERTO
			CREATE TABLE Aeropuerto (
				...
				nombre VARCHAR2(50) NOT NULL,
				codigo_iata VARCHAR2(5) NOT NULL,
	...
	-- HABITACIONES
		-- ALOJAMIENTO
			CREATE TABLE Alojamiento (
				...
				CONSTRAINT alojamiento_fk_lugar FOREIGN KEY (fk_lugar) REFERENCES Lugar(id)
			);
		...
		-- HABITACION
			CREATE TABLE Habitacion (
				...
				CONSTRAINT habitacion_fk_alojamiento FOREIGN KEY (fk_alojamiento) REFERENCES Alojamiento(id)
			);
	...
	-- CLIENTES
		...
		-- TARJETA
			CREATE TABLE Tarjeta  (
				...
				tipo CHAR(1) CHECK (tipo = 'C' OR tipo = 'D'),
				banco VARCHAR2(50),
		...
		-- RESERVACION
			CREATE TABLE Reservacion  (
				-- GENERAL
					...
					esta_cancelada CHAR(1) CHECK( esta_cancelada = 'T' OR esta_cancelada = 'F' ),
					fecha_reservacion TIMESTAMP NOT NULL,

					CONSTRAINT reservacion_pk PRIMARY KEY (id),
					CONSTRAINT reservacion_fk_cliente FOREIGN KEY (fk_cliente) REFERENCES Cliente(id),
