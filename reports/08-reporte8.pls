CREATE OR REPLACE PROCEDURE reporte8 (cursor8 OUT SYS_REFCURSOR, fechaInicio IN TIMESTAMP, fechaFin IN TIMESTAMP, lugarOrigen IN VARCHAR2 DEFAULT '', lugarDestino IN VARCHAR2 DEFAULT '')
IS
    logo BLOB;
    fecha VARCHAR2(100);
    lOrigen VARCHAR2(50);
